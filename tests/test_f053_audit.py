...
@pytest.mark.xfail(reason="F-05.3 — audit IA legacy basado en chatbot.py eliminado · ver docs/review/2026-05-19/v2/backlog/ — recuperar cuando se implemente", strict=False)
@pytest.mark.asyncio
