Ejecuta la **Fase 7: Gestión de Cambios y Revisión de Backlog** del pipeline de ingeniería de requisitos.
...
6. Mostrar matriz de impacto en chat y esperar confirmación antes de modificar nada.
7. Aplicar solo los cambios aprobados explícitamente por el usuario.
8. Actualizar `docs/src/AUDIT_LOG.md` con registro CHANGE-XX.
