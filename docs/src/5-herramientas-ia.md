...
1. [Prerrequisitos de runtime (host)](#prerrequisitos-de-runtime-host)
2. [Arrancar Claude con el entorno del proyecto](#arrancar-claude-con-el-entorno-del-proyecto)
3. [MCPs incluidos](#mcps-incluidos)
